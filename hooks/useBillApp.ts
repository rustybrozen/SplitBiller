...
export const useBillApp = () => {
  ...
  return {
    state: {
      activeTab, members, bills, settings,
      newMemberName, isEditingBill, editingBillId,
      billAmount, billDesc, billPayer, billSplitType, billSelectedMembers, billExtraSplits,
      isSplitDialogOpen, currentSplitItem, historyDetailBill
    },
    computed: {
      t, isDark, openBillsCount, groupedTransfers,
      remainingAmount: getRemainingAmount()
    },
    actions: {
      setActiveTab, setMembers, setBills, setSettings,
      setNewMemberName, setIsEditingBill, setEditingBillId,
      setBillAmount, setBillDesc, setBillPayer, setBillSplitType, setBillSelectedMembers, setBillExtraSplits,
      setIsSplitDialogOpen, setCurrentSplitItem, setHistoryDetailBill,
      addMember, removeMember, handleSaveBill, editBill, cancelEdit, deleteBill,
      openAddSplitItem, saveSplitItem, removeSplitItem, settleAllBills,
      formatMoney, formatNumberOnly
    }
  };
};